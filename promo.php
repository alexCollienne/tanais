...
<title>Magasin Tana&iuml;s - Perlerie | Site de vente en ligne | Soldes</title>
</head>
...
<div id="content">
<?php
	$aArticle = dataManager::Read('ts_promo',array(array('sType','=','promo')),array('ts_promo.sDate','DESC'),array(0,36),array(array('INNER JOIN','ts_catalogue',array(array('ts_promo.iArticle','=','ts_catalogue.ID')))));
